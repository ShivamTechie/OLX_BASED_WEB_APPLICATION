...
<head>
  ...
  <title>NexusPlus: search result</title>
...
<body>
            ...
            <div class="contents">
              ...
              <div class="search-bar">
                <div class="search-inner">
                  <form class="search-form" id="search-form-glob">
                    <div class="form-group">
                      <input type="text" name="query" id="customword" class="form-control" placeholder="What are you looking for?">
                    </div>
                    ...
                    <button class="btn btn-common" type="button" id="search-btn-glob"><i class="lni-search"></i> Search Now</button>
                  </form>
        ...
        <div class="col-lg-3 col-md-12 col-xs-12 page-sidebar">
          <aside>
            <div class="widget_search">
              <form role="search" id="search-form " class="individual-search">
                <input type="search" class="form-control" autocomplete="off" name="query" placeholder="Search..." id="search-input" value="" />
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="featured-box">
                      ...
                      <div class="feature-content">
                        ...
                        <h4>
                          <a href="ads-details.html">Brown Leather Bag ...</a>
                        </h4>
                        <div class="meta-tag">
                          <span>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="featured-box">
                      ...
                      <div class="feature-content">
                        ...
                        <h4>
                          <a href="ads-details.html">Canon FX Powershot ...</a>
                        </h4>
                        <div class="meta-tag">
                          <span>
                            <a href="#"><i class="lni-user"></i> John Smith</a>
  ...
  <!-- <script src="assets/js/Ajax/categoriesWithCount.js"></script> -->
  <!-- <script src="assets/js/Ajax/fetchAllProducts.js"></script> -->
  <script src="assets/js/Ajax/categories.js"></script>
  <script src="assets/js/Ajax/globalsearch.js"></script>
