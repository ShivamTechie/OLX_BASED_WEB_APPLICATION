  ...
  <head>
    ...
    <title>NexusPlus - Edit Ads</title>
  ...
  <body>
                ...
                <div class="inner-box">
                  ...
                  <div class="dashboard-wrapper">
                    ...
                    <label class="tg-fileuploadlabel mt-4" for="tg-photogallery">
                      ...
                      <!-- <span class="error" id="file-error">Please select  images.</span> -->
                    </label>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Are you sure you want to change this Listing?
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            <button type="button" class="btn btn-danger" id="confirmDelete">Apply changes</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="assets/js/Ajax/updateProduct.js"></script>
