...
<body>
  ...
  <div id="content" class="section-padding">
    <div class="container" style="max-width: 1490px !important;">
      <div class="row">
        <div class="col-lg-8 col-md-12 col-lg-12 col-xs-12">
          ...
          <iframe width="100%" height="1600" src="https://rss.app/embed/v1/magazine/tcaHErj1matilWA0" frameborder="0"></iframe>
